  ...
  function ImageGallery(
    ...
    return (
      ...
      >
          ...
          {images.length === 0 ? (
            ...
            >
              {images.map((image) => (
                ...
                >
                  <span data-slot="image-gallery-image" className="contents">
                    {renderImage?.(image, { lightbox: false }) ?? (
                      <img
                        src={image.src}
                        alt={image.alt}
                        width={image.width}
        ...
        <Dialog.Portal>
          <Dialog.Backdrop
            data-slot="image-gallery-backdrop"
          ...
          />
          <Dialog.Viewport
            data-slot="image-gallery-viewport"
          ...
          >
            {selectedImage && (
              ...
              >
                ...
                <span
                  data-slot="image-gallery-lightbox-image"
                  className="contents"
                >
                  {renderImage?.(selectedImage, { lightbox: true }) ?? (
                    <img
